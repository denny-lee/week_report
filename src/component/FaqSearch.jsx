...
const FaqSearch = React.createClass({
  	getInitialState() {
        return {
            itemList: []
        };
  	...
  	render() {
	    ...
	    const items = itemList.map((k, i) => {
	    	...
	    	return <Card title={k.question} key={i}>
	    	...
	    	<div>
		      	<Form onSubmit={this.submitHandler} form={this.props.form}>
			        <Row type="flex" justify="center">
			            <Col span={8}>
			                <FormItem>
			                    <Input {...tagProp} placeholder="input tag or question hear." />
			                </FormItem>
			            </Col>
...
const FaqSearchForm = Form.create()(FaqSearch);
